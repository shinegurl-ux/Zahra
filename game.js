...
const story = [
...

   {
        ...
        question: "من اين يفرز هرمون الباراثرمون؟",
        ...
        choices: [
            ...
            {
                text: "الغدة الجاردرقية",
                response: "شطور!. السؤال كان برعاية آية",
                expression: "normal"
            }
        ]
    },

    {
        ...
        question: "في المكثف مع التيار المتردد الجيبي الذي يسبق اولاً هو؟",

        choices: [
            {
                text: "التيار",
                response: "التيار يسبق الجهد بربع دورة.",
                expression: "normal"
            },

            {
                text: "الجهد",
                response: "!غير صحيح، التيار يسبق الجهد ب 90°",
                expression: "disappointed"
            }
        ]
    },
